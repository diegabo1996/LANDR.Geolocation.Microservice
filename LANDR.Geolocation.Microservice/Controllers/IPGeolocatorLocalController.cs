...
namespace LANDR.Geolocation.Microservice.Controllers
{
    ...
    [ApiController]
    public class IPGeolocatorLocalController : ControllerBase
    {
        private readonly IQueryManager query;
        private readonly ILogger<WeatherForecastController> _logger;
        public IPGeolocatorLocalController(QueryLocal LocalService, ILogger<WeatherForecastController> logger)
        {
            query = LocalService;
            _logger = logger;
        }
